...
class COCOeval_opt(COCOeval):
    ...
    def evaluate(self):
        ...
        p.kpt_oks_sigmas = list(np.unique(p.kpt_oks_sigmas))
        ...
        ious = [[[self.ious[imgId, catId, kpt_oks_sigma] for catId in catIds] for imgId in p.imgIds] for kpt_oks_sigma in kpt_oks_sigmas]
